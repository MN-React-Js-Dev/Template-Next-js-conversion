...
import MonitorIcon from '../../../../public/icons/monitor-dashboard.svg';
    ...
    >
      <div className="relative rounded">
        <div className="flex justify-center overflow-hidden rounded-lg">
          ...
          <Image src="/live-class-1.jpg" width={590} height={366} />
        </div>
        ...
        <div className="z-1 absolute top-10 left-3 flex items-center rounded-full bg-[#565656] bg-opacity-90 px-2 py-1 text-[7px] font-bold text-white">
          Only 2 Spots Left
        </div>
      </div>

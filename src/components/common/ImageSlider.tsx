  ...
  return (
    <div className="relative pt-10 md:pt-14 lg:pt-20">
      ...
      <div className="mt-10 text-center">
        <Link href="#">
          <a className="green_btn focus_green mx-auto flex h-[44px] w-[160px] items-center justify-center rounded-lg p-1 text-[13px] font-bold text-white transition-shadow hover:shadow-lg">
            View all Photos
          </a>
        </Link>
      </div>

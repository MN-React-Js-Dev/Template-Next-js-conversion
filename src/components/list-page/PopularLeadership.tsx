...
const PopularLeadership = () => {
  ...
  return (
    <div className="relative pt-3 pb-5 md:pt-0">
      <motion.div
      ...
      <div className="pl-2 md:container md:pl-3">
        <motion.div
          variants={fadeInUp}
          className="popular_leadership_slider slider__id_1 relative"
        >
          <Swiper
            ...
            navigation={{
              prevEl:
                '.popular_leadership_slider.slider__id_1 .swiper-button-prev',
              nextEl:
                '.popular_leadership_slider.slider__id_1 .swiper-button-next',
            }}
            spaceBetween={0}
          >

...
import OneDayInfoPopup from './popups/OneDayInfoPopup';
      ...
      >
        <div className="flex flex-wrap justify-between gap-14 lg:flex-nowrap">
          <div className="w-full">
            <div className="flex w-full flex-wrap items-start sm:flex-nowrap">
              ...
              <motion.div variants={fadeIn} className="w-full sm:ml-4">
                <div className="flex flex-wrap justify-between gap-y-2 xl:flex-nowrap">
                  <div className="flex flex-wrap items-center gap-y-2 sm:flex-nowrap">
                    ...
                    <div className="mr-3 flex w-full items-center sm:w-auto">
                      <div className="mr-2 text-sm font-bold text-[#8796A0] lg:text-[13px] xl:text-sm">
                        One Day Workshop
                      </div>
                      <button
                        type="button"
          ...
          {width > 1024 ? (
            <div className="shrink-0">
              <div>
                <Image src="/dummy-gig-frame-1.jpg" width={375} height={571} />
              </div>
        ...
        {width < 1025 ? (
          <div className="mt-10 shrink-0">
            <div>
              <Image src="/dummy-gig-frame.jpg" width={375} height={571} />
            </div>

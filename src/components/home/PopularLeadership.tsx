...
const PopularLeadership = () => {
  ...
  return (
    <div className="relative py-14">
      <div className="pointer-events-none absolute -left-20 top-0 rotate-45 transform">
      ...
      <div className="pl-2 md:container md:pl-3">
        <motion.div
          variants={fadeInUp}
          className="popular_leadership_slider relative"
        >
          <Swiper
            ...
            freeMode
            navigation={{
              prevEl: '.popular_leadership_slider .swiper-button-prev',
              nextEl: '.popular_leadership_slider .swiper-button-next',
            }}
          >
            {sliderItems.map((item) => (
              <SwiperSlide
                key={item.id}
                className="!w-[85%] md:!w-[68.5%] lg:!w-[32%]"
              >
                <div
                  className="m-2 mb-3 overflow-hidden rounded-lg bg-cover bg-center bg-no-repeat px-3 py-2 shadow-lg"
                  style={{
                ...
                >
                  <div>
                    ...
                    <h4 className="mt-[80px] max-w-[220px] text-xl font-extrabold leading-tight text-white md:mt-[100px]">
                      {item.title}
                    </h4>
...
export default PopularLeadership;
